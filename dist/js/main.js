!function(console, document, location, $) {
    ...
    var reason, reasonDescription, thanksBar = $("#thanksBar"), registerBar = $("#registerBar"), areaNames = [ "Norfolk", "Virginia Beach", "Hampton Roads", "Chesapeake", "Newport News", "Coastal Virginia", "Portsmouth", "Suffolk", "Hampton", "Tidewater" ], currentArea = 0;
